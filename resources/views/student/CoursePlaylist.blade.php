                ...
                @switch($course->type)
                    @case(1) <!-- File -->
                        <div class="list-group-item">
                            <a href="{{ route('file',['id' => $course->id ,'token' => $token]) }}"><p class="mb-0"><i
                    ...
                    @case(2) <!-- Video -->
                        <div class="list-group-item">
                            <a href="{{ route('view',['id' => $course->id ,'token' => $token]) }}"><p class="mb-0"><i
                    ...
                    @case(3) <!-- Article -->
                        <div class="list-group-item">
                            <a href="{{ route('article',['id' => $course->course_url ,'token' => $token]) }}"><p
                                        class="mb-0"><i
