        ...
        <form method="POST" enctype="multipart/form-data" class="md-form" autocomplete="off">
            ...
            <div class="md-form">
                ...
                <input type="text" id="name"
                       class="form-control disabled {{ $errors->has('name') ? ' is-invalid' : '' }}" disabled
                       value="{{ $user->name }}">
            ...
            <div class="md-form">
                ...
                <input type="text" id="id_national" required class="form-control" name="identity_national_number"
                       value="@if(!empty($details->identity_national_number)){{ $details->identity_national_number }}@endif">
                <label for="id_national">National identity number</label>
            </div>
            <div class="md-form">
                <i class="fas fa-birthday-cake prefix"></i>
                <input placeholder="Selected date" required type="text"
                       data-value="@if(!empty($details->birthday)){{ $details->birthday }}@endif" name="birthday"
                       id="date-picker" class="form-control datepicker">
                <label for="date-picker">Birthday</label>
            </div>
            <div class="md-form">
                <i class="fas fa-map-marker prefix"></i>
                <input type="text" id="birthday_place" required class="form-control" name="birthday_place"
                       value="@if(!empty($details->birthday_place)){{ $details->birthday_place }}@endif">
            ...
            <div class="md-form">
                ...
                <input type="tel" id="phoneNumber" name="phone_number"
                       ...
                       value="@if(!empty($details->phone_number)){{ $details->phone_number }}@endif">
            ...
            <div class="md-form">
                ...
                <input type="text" id="address" name="address"
                       class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}"
                       value="@if(!empty($details->address)){{ $details->address }}@endif">
            ...
            <div class="md-form">
                ...
                <textarea type="text" name="resume" id="form10" class="md-textarea form-control"
                          rows="3">@if(!empty($details->resume)){{ $details->resume }}@endif
                </textarea>
