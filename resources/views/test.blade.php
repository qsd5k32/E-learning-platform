...
<body class="postpage-v1 hidden-sn animated">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent-4">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown ml-4 mb-0">
                        <a class="nav-link dropdown-toggle waves-effect waves-light dark-grey-text font-weight-bold " id="navbarDropdownMenuLink" data-toggle="dropdown"
                    ...
                    <li class="nav-item dropdown ml-4  mb-0">
                        <a class="nav-link dropdown-toggle waves-effect waves-light dark-grey-text font-weight-bold" id="navbarDropdownMenuLink-2" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false"> POST PAGE </a>
                    ...
                    <li class="nav-item dropdown ml-4  mb-0">
                        <a href="#" class="nav-link dropdown-toggle waves-effect waves-light dark-grey-text font-weight-bold" id="navbarDropdownMenuLink-4"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <!--Card image-->
                                    <div class="view overlay">
                                        <img src="https://mdbootstrap.com/img/Photos/Slides/img%20(29).jpg" class="img-fluid" alt="">
                                        <a>
                                            <div class="mask rgba-white-slight"></div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row my-3 mx-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <img src="https://mdbootstrap.com/img/Photos/Others/square/19.jpg" class="img-fluid z-depth-1 rounded-0" alt="sample image">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img src="https://mdbootstrap.com/img/Photos/Others/square/10.jpg" class="img-fluid z-depth-1 rounded-0" alt="sample image">
                                        ...
                                        <div class="row mx-4">
                                            ...
                                            <p class="dark-grey-text article mb-4">Omnis iste natus error sit voluptatem accusantium doloremque laudantium,
